...
import { Shield, DollarSign, Gamepad, Gift, Image, Settings, Music, Wrench, Info, Sword, LifeBuoy } from 'lucide-react';
...
import { imageToolCommands } from './image';
